            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3><span class="glyphicon glyphicon-dashboard"></span> {{ this.type+'s' }} </h3> <br>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-striped table-responsive" v-if="items.length > 0">
                            <tbody>
                            <tr>
                                <th>No.</th>
                                <th>Name</th>
                            ...
                            <tr v-for="(principle, index) in items">
                                <td>{{ index + 1 }}</td>
  ...
  export default {
    ...
    methods: {
      ...
      readItems()
      {
        axios.get('/'+this.type)
          .then(response => {
            this.items = response.data[this.type+'s'];
          });
      },
      createPrinciple()
      {
      ...
      deletePrinciple(index)
      {
        ...
        if (conf === true) {
          axios.delete('/principle/' + this.items[index].id)
            .then(response => {
      ...
      initUpdate(index)
      {
        ...
        this.update_principle = this.items[index];
      },
